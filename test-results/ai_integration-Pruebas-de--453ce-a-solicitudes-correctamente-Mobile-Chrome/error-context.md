...
- Name: ai_integration.spec.ts >> Pruebas de Integración de IA (Cerebro Neural Gemini con Autenticación Real) >> La Edge Function de Reclutamiento IA (recruiter-ai) procesa solicitudes correctamente
- Location: e2e\ai_integration.spec.ts:117:3
