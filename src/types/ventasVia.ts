...
// Re-exported from types/ventas.ts for module aliasing consistency
...
export {
  VENTAS_ESTATUS_LABELS,
  VENTAS_ESTATUS_OPTIONS,
  DEFAULT_VENTAS_ETAPAS,
} from './ventas';

// Keep the union type literal here for explicit use
export type VentasEstatusLiteral =
  | 'PROSPECTO'
  | 'PROPUESTA'
  | 'NEGOCIACION'
  | 'PEDIDO'
