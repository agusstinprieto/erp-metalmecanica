...
export const MODULE_GUIDES: Record<string, ModuleGuide> = {
  ...
  quality: {
    ...
    steps: [
      ...
      {
        icon: 'Camera', color: 'text-emerald-400', bg: 'bg-emerald-500/10 border-emerald-500/30',
        title: 'Hub CCTV — Cámaras Go/No-Go y Visión Soldadura',
        subtitle: 'Inspección automatizada con cámaras industriales',
        tips: [
          '📷 Pestaña "CCTV Hub" dentro de Calidad — ingresa la URL MJPEG de tu cámara IP para verla en vivo.',
          '🔴 Modo Go/No-Go: compara la pieza ensamblada vs el patrón ideal y emite veredicto PASS/FAIL automático.',
          '🔥 Modo Soldadura: el feed en vivo detecta porosidades, socavación y spatter en tiempo real sobre el cordón.',
          '🎬 Sin cámara: activa el simulador de demo ("Demo Mode") para ver cómo funciona el análisis con video de ejemplo.',
          '🔧 Requiere cámara IP industrial con salida MJPEG o RTSP — el software ya está listo para recibirla.',
        ],
      },
      {
        icon: 'Microscope', color: 'text-purple-400', bg: 'bg-purple-500/10 border-purple-500/30',
        title: 'Microscopía Digital de Microdefectos',
        subtitle: 'Detección de microfisuras con microscopio USB',
        tips: [
          '🔬 Conecta un microscopio USB digital (tipo Andonstar o similar) para capturar imágenes macro de alta resolución.',
          '🤖 La IA detecta microfisuras, porosidades subsuperficiales y discontinuidades estructurales no visibles a simple vista.',
          '📐 Identifica fisuras de templado, delaminaciones de recubrimiento y fracturas por fatiga antes de que sean críticas.',
          '📋 El reporte incluye nivel de riesgo estructural y recomendación de ajuste para el supervisor de calidad.',
          '🔧 Requiere microscopio USB digital — el software de análisis está 100% programado y listo.',
        ],
      },
    ],
  },
  ...
  rh: {
    ...
    steps: [
      ...
      {
        icon: 'Printer', color: 'text-indigo-400', bg: 'bg-indigo-400/10 border-indigo-400/30',
        title: 'Impresión de Gafetes Corporativos',
        subtitle: 'Genera carnés con código de barras para toda la plantilla',
        tips: [
          '── FLUJO DE IMPRESIÓN ─────────────────────────────',
          '1️⃣  Ir a Módulo RH → Censo de Empleados',
          '2️⃣  Seleccionar empleados: usa el ✓ individual en cada tarjeta/fila, o el checkbox del encabezado para TODOS',
          '3️⃣  Aparece el botón morado "IMPRIMIR GAFETES (N)" en la barra de herramientas',
          '4️⃣  El modal muestra la vista previa de los N gafetes (85×135 mm) con foto, nombre, cargo, depto, turno y código de barras',
          '5️⃣  Clic en "Imprimir N gafetes" → se abre el diálogo de impresión del navegador',
          '6️⃣  Seleccionar la impresora de tarjetas plásticas (Fargo, Zebra, Matica, Evolis…)',
          '7️⃣  Desactivar "Ajustar al área de impresión" · Confirmar tamaño de página 85×135 mm',
          '8️⃣  El driver envía N páginas → la impresora alimenta 1 tarjeta por cada página automáticamente',
          '── IMPRESORA DE TARJETAS ──────────────────────────',
          '🖨️ Se instala como impresora normal en Windows — aparece en el diálogo de Chrome/Edge',
          '🃏 El feeder físico alimenta 1 tarjeta plástica (PVC) por cada página recibida',
          '✅ Un solo trabajo de impresión = N tarjetas; no es necesario enviar una por una',
          '🎨 Asegúrate que la impresora esté configurada en modo "Color" y resolución 300 dpi mínimo',
          '── CONSEJO PRO ────────────────────────────────────',
          '💾 También puedes elegir "Guardar como PDF" en el diálogo para generar un archivo y llevarlo a otro equipo con la impresora',
        ],
      },
    ],
  },
